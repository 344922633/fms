<template>
    <div class="container">
        ...
        <el-table :data="tableData.slice((currentPage-1)*pageSize,currentPage*pageSize)" border class="table"
            ...
            <el-table-column prop="path" align="center" label="上传路径" width="120">
            </el-table-column>
            <el-table-column label="操作" align="center" width="240">
                <template slot-scope="scope">
                    ...
                    <el-button type="text" icon="el-icon-caret-right" class="red"
                               @click="uploadFile(scope.$index, scope.row)">启动
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="40%"  >
            <el-form ref="form" :model="form" :label-position="labelPosition" label-width="150px" :rules="rules">
                <el-form-item label="ip：" prop="ip">
                    <el-input v-model="form.ip"></el-input>
                </el-form-item>
                <el-form-item label="用户名：" prop="userName">
