...
public class SFTPUtilsNew {
    ...
    public SFTPUtilsNew(String host, int port, String username, String password) {
        this.host = host;
    ...
    public SFTPUtilsNew(String host, String username, String password) {
        this.host = host;
        this.username = username;
        this.password = password;
    }
     ...
     * @return
     */
    public List<String> batchDownLoadFileAll(String remotePath, String localPath,
                                           String fileFormat, String fileEndFormat, boolean del) {
        List<String> filenames = new ArrayList<String>();
        try {
            // connect();
                ...
                while (it.hasNext()) {
                    ...
                    if (!attrs.isDir()) {
                        ...
                        if(!filename.equals("..")&&!filename.equals(".")){
                            batchDownLoadFileAll(remotePath+filename+"/",localPath,fileFormat,fileEndFormat,del);
    ...
    public static void main(String[] args) {
        SFTPUtilsNew sftp = null;
        // 本地存放地址
        String localPath = "F:/Users/";
        // Sftp下载路径
        String sftpPath = "/home/xuhubin/";
        List<String> filePathList = new ArrayList<String>();
        try {
            sftp = new SFTPUtilsNew("47.93.196.60", 22, "root", "admin!123");
            sftp.connect();
            System.out.println("version==" + sftp.sftp.getServerVersion());
            // 下载
            sftp.batchDownLoadFileAll(sftpPath, localPath, "", "", false);
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            sftp.disconnect();
